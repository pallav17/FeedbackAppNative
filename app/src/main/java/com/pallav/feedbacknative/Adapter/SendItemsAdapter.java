...
public class SendItemsAdapter extends RecyclerView.Adapter<SendItemsAdapter.MyViewHolder> {
    ...
    public SendItemsAdapter(ArrayList<HashMap<String, String>> arrData) {
        this.arrData = arrData;
    }

    // Create new views (invoked by the layout manager)
    @Override
    public SendItemsAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent,
                                                               int viewType) {
        // create a new view
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        holder.feedback_sender.setText("To: " + arrData.get(position).get("FirstName") + " " + arrData.get(position).get("LastName"));
